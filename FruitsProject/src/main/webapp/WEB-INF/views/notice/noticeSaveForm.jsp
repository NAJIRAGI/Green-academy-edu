		...
		<div class="row">
			<div class="col-lg-8 col-sm-12">
				<div class="contact-form-right">
					<h2>공지사항</h2>
					<p>공지사항의 내용을 작성하시고 확인 버튼을 눌러주세요!</p>
					<form>						
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" id="title" name="name"
										placeholder="Title" required data-error="Please enter your Subject">
					...
					<button class="btn hvr-hover" id="btn-Nsave">Notice Upload</button>
				</div>
			</div>
		</div>
	</div>
