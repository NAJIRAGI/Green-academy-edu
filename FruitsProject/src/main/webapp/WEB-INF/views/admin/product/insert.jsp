			...
			<div class="row new-account-login">
				<div class="col-sm-6 col-lg-6 mb-3">
					<div class="title-left">
						<h3>Insert My Product!</h3>
					</div>
					<h5>Product Insert Page!</h5>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6 col-lg-6 mb-3">
					<div class="checkout-address">
						<div class="title-left">
							<h3>상품에 대한 내용을 작성 후 등록 버튼을 눌러주세요!</h3>
						</div>
						<form class="needs-validation" novalidate enctype="multipart/form-data">						

							<div class="mb-3">
								<label for="productName">Product Name</label> <input type="text"
									class="form-control" id="productName" placeholder="" required>
							...
							<div class="mb-3">
								<label>Product Price</label> <br> Sale Price<input
									...
									placeholder="할인 적용 전 가격 입력 / 할인 없으면 미기입" id="bprice">Current
								Price<input type="text" class="form-control" id="price"
									placeholder="할인 적용 후 가격 입력">
								<div class="invalid-feedback">가격을 입력해주세요.</div>
							</div>						

							<div class="mb-3">
								<label for="origin">Product Origin</label><br> 국산 <input
									type="radio" id="origin" value="국산" name="origin" checked="checked"> 수입<input
							...
							<div class="mb-3">
								<label for="season">Season Product Checked.</label> <br> 봄 <input
									type="radio" id="season" value="봄" name="season" checked="checked"> 여름<input
							...
							<div class="mb-3">
								...
								<div class="form-group">
									<textarea class="form-control" id="productDetail"
										...
										data-error="Write Product Detail" required></textarea>
							...
							<div class="col-lg-12">
								<div class="special-menu text-center">
									<div class="button-group filter-button-group">
										<button id="btn-prodinsert" class="btn">등록 완료</button>
									</div>
								</div>
							</div>
						</div>			
