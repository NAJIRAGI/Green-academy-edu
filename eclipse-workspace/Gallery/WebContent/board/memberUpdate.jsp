			...
			<tr>
				...
				<c:choose>
					<c:when test="${mVo.admin == 0}">
						<input type="radio" name="admin" value="0" size="20" checked="checked">일반회원
						<input type="radio" name="admin" value="1" size="20">관리자
					</c:when>
					<c:otherwise>
						<input type="radio" name="admin" value="0" size="20">일반회원
						<input type="radio" name="admin" value="1" size="20" checked="checked">관리자
					</c:otherwise>
				</c:choose>	
				</td>
			</tr>
